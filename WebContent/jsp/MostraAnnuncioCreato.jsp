	...
	<body>
		...
		<div class=pannelloVerde>
			...
			<div id="dettagli">
				 ...
				 <div class="rigaDettaglio"><label class="Label2">Email venditore:</label><label class="Label"> <%=" "+ annuncio.getEmail() %></label></div>
			</div>
			
			
			<div id="azioni">
				<% if(user != null) {%>	
					<form action="jsp/ModificaAnnuncio.jsp" method="get">
					    <input type="hidden" name="targa" value="<%= annuncio.getTarga() %>">
					    <input class="in" type="submit" value="Modifica annuncio">
					</form>
				
					<form action="/SVcars/EliminaAnnuncioServlet" method="get">
						<input type="hidden" name="targa" value="<%= annuncio.getTarga() %>">
						<input class="in" type="submit" value="Elimina annuncio">
					</form>
				<%}%>
			</div>
